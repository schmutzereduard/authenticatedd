...
class AuthControllerTest {
    ...
    void isAuthorizedSuccess() {
        ...
        when(tokenService.isValidToken(mockToken.getToken())).thenReturn(mockToken);
    ...
    void isAuthorizedFail() throws Exception {
        ...
        when(tokenService.isValidToken(mockToken.getToken())).thenThrow(new JwtException(EXPIRED_TOKEN_MESSAGE));
